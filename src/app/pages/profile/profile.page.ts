...
export class ProfilePage implements OnInit {
  ...
  async updateEmail(): Promise<void> {
    const alert = await this.alertCtrl.create({
      message: 'Actualización de correo',
      inputs: [
        { type: 'text', name: 'newEmail', placeholder: 'Ingrese su nuevo correo' },
        { name: 'password', placeholder: 'Confirme su conrtraseña', type: 'password' }
      ],
      buttons: [
        { text: 'Cancelar' },
        {
  ...
  async updatePassword(): Promise<void> {
    const alert = await this.alertCtrl.create({
      message: 'Actualización de contraseña',
      inputs: [
